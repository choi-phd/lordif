...
function(x,mfrow=c(3,1),width=7,height=7,BW=FALSE,...) {
    ...
    plot(Item,x$cutoff$pseudo12.McFadden,ylab=substitute(paste0(R[2]^2," - ",R[1]^2)),type="b",col=cols[1],lty=1,ylim=c(0,max.R2))
    ...
    plot(Item,x$cutoff$pseudo13.McFadden,ylab=substitute(paste0(R[3]^2," - ",R[1]^2)),type="b",col=cols[1],lty=1,ylim=c(0,max.R2))
    ...
    plot(Item,x$cutoff$pseudo23.McFadden,ylab=substitute(paste0(R[3]^2," - ",R[2]^2)),type="b",col=cols[1],lty=1,ylim=c(0,max.R2))
